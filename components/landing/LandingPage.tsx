          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs text-white/90 font-semibold">PostgreSQL Row-Level Security (RLS) active</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-4 h-4 text-primary-light" />
                <span className="text-xs text-white/90 font-semibold">Defense-in-depth Role-Based Access Controls</span>
              </div>
              <div className="flex items-center gap-3">
                <CheckCircle className="w-4 h-4 text-primary-light" />
                <span className="text-xs text-white/90 font-semibold">Server-Calculated Billing Totals (Anti-Tampering)</span>
              </div>
            </div>
          </div>
