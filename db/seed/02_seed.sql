...
('77777777-7777-7777-7777-777777777777', '77777777-7777-7777-7777-777777777777', '{"sub":"77777777-7777-7777-7777-777777777777","email":"superadmin@vetflow.com","email_verified":true}'::jsonb, 'email', now(), now(), now()),
('a9000000-0000-0000-0000-000000000000', 'a9000000-0000-0000-0000-000000000000', '{"sub":"a9000000-0000-0000-0000-000000000000","email":"admin.a@vetcare.com","email_verified":true}'::jsonb, 'email', now(), now(), now()),
('ad000000-0000-0000-0000-000000000000', 'ad000000-0000-0000-0000-000000000000', '{"sub":"ad000000-0000-0000-0000-000000000000","email":"doctor.a@vetcare.com","email_verified":true}'::jsonb, 'email', now(), now(), now()),
('ar000000-0000-0000-0000-000000000000', 'ar000000-0000-0000-0000-000000000000', '{"sub":"ar000000-0000-0000-0000-000000000000","email":"receptionist.a@vetcare.com","email_verified":true}'::jsonb, 'email', now(), now(), now()),
('b9000000-0000-0000-0000-000000000000', 'b9000000-0000-0000-0000-000000000000', '{"sub":"b9000000-0000-0000-0000-000000000000","email":"admin.b@animalhospital.com","email_verified":true}'::jsonb, 'email', now(), now(), now()),
('bd000000-0000-0000-0000-000000000000', 'bd000000-0000-0000-0000-000000000000', '{"sub":"bd000000-0000-0000-0000-000000000000","email":"doctor.b@animalhospital.com","email_verified":true}'::jsonb, 'email', now(), now(), now());
...
('p2000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'c2000000-0000-0000-0000-000000000000', 'Bella', 'Cat', 'Siamese', 'Spayed Female', '2023-04-10', 4.20, 'Penicillin', 'Allergic to specific antibiotics'),
...
('ap100000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'p1000000-0000-0000-0000-000000000000', 'John Doe', 'john.doe@gmail.com', '555-9090', 'Max', 'Dog', current_date, '10:00:00', 'Routine checkup & vaccinations', 'confirmed', 'ad000000-0000-0000-0000-000000000000'),
('ap200000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'p2000000-0000-0000-0000-000000000000', 'Jane Smith', 'jane.smith@gmail.com', '555-8080', 'Bella', 'Cat', current_date, '14:30:00', 'Ear scratching check', 'confirmed', 'ad000000-0000-0000-0000-000000000000');
...
('v1000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'p2000000-0000-0000-0000-000000000000', 'c2000000-0000-0000-0000-000000000000', 'ap200000-0000-0000-0000-000000000000', 'Severe ear irritation', 'waiting', now() - interval '20 minutes', null),

-- Visit 2: Consulting in progress
('v2000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'p1000000-0000-0000-0000-000000000000', 'c1000000-0000-0000-0000-000000000000', 'ap100000-0000-0000-0000-000000000000', 'Limping on right hind leg', 'consulting', now() - interval '45 minutes', null),

-- Visit 3: Completed yesterday
('v3000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'p1000000-0000-0000-0000-000000000000', 'c1000000-0000-0000-0000-000000000000', null, 'Routine skin allergy booster', 'completed', now() - interval '1 day 2 hours', now() - interval '1 day 1 hour');

-- Assign doctors
INSERT INTO public.visit_assignments (visit_id, doctor_id, assigned_at) VALUES
('v1000000-0000-0000-0000-000000000000', 'ad000000-0000-0000-0000-000000000000', now() - interval '15 minutes'),
('v2000000-0000-0000-0000-000000000000', 'ad000000-0000-0000-0000-000000000000', now() - interval '40 minutes');
...
('cn100000-0000-0000-0000-000000000000', 'v3000000-0000-0000-0000-000000000000', 'Mild dermatitis and skin itch', 'History of seasonal allergies in spring', 'Redness around paws and belly. No signs of infection.', 'Atopic Dermatitis', 'Start Amoxicillin as prophylaxis, keep paws clean.', 'Recheck in 10 days if itching persists', 'ad000000-0000-0000-0000-000000000000');
...
('pr100000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'v3000000-0000-0000-0000-000000000000', 'p1000000-0000-0000-0000-000000000000', 'ad000000-0000-0000-0000-000000000000', 1, 'Standard antibiotic course for skin scratch prevention', true);
...
('pr100000-0000-0000-0000-000000000000', 'pr100000-0000-0000-0000-000000000000', 'Amoxicillin 250mg', '1 tablet', 'Twice daily', '7 days', 'Give with food to prevent nausea', 14);
...
('i1000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'INV-2026-0001', 'c1000000-0000-0000-0000-000000000000', 'p1000000-0000-0000-0000-000000000000', 'v2000000-0000-0000-0000-000000000000', 75.00, 0.00, 15.00, 11.25, 86.25, 'unpaid', 'Due on completion of doctor consulting.', 'ad000000-0000-0000-0000-000000000000');

INSERT INTO public.invoice_items (invoice_id, product_id, name, quantity, unit_price, tax_amount, total) VALUES
('i1000000-0000-0000-0000-000000000000', 'pr300000-0000-0000-0000-000000000000', 'General Consultation', 1, 50.00, 7.50, 57.50),
('i1000000-0000-0000-0000-000000000000', 'pr200000-0000-0000-0000-000000000000', 'Premium Puppy Food', 1, 25.00, 3.75, 28.75);
...
('i2000000-0000-0000-0000-000000000000', 'a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'INV-2026-0002', 'c1000000-0000-0000-0000-000000000000', 'p1000000-0000-0000-0000-000000000000', 'v3000000-0000-0000-0000-000000000000', 71.00, 0.00, 15.00, 10.65, 81.65, 'paid', 'Fully settled.', 'ad000000-0000-0000-0000-000000000000', now() - interval '1 day');

INSERT INTO public.invoice_items (invoice_id, product_id, name, quantity, unit_price, tax_amount, total) VALUES
('i2000000-0000-0000-0000-000000000000', 'pr300000-0000-0000-0000-000000000000', 'General Consultation', 1, 50.00, 7.50, 57.50),
('i2000000-0000-0000-0000-000000000000', 'pr100000-0000-0000-0000-000000000000', 'Amoxicillin 250mg', 14, 1.50, 3.15, 24.15);
...
('a0000000-0000-0000-0000-000000000000', 'a1000000-0000-0000-0000-000000000000', 'i2000000-0000-0000-0000-000000000000', 81.65, 'cash', 'CASH-99120', 'ar000000-0000-0000-0000-000000000000', now() - interval '1 day');
